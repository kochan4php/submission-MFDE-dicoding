...
// in ditonton/test/presentation/pages/tv_series/airing_tv_series_page_test.dart.
...
class MockAiringTvSeriesNotifier extends _i1.Mock
  ...
  @override
  List<_i4.TvSeries> get airingTvSeries => (super.noSuchMethod(
        Invocation.getter(#airingTvSeries),
        returnValue: <_i4.TvSeries>[],
      ) as List<_i4.TvSeries>);

  @override
  _i5.RequestState get airingState => (super.noSuchMethod(
        Invocation.getter(#airingState),
  ...
  @override
  _i7.Future<dynamic> fetchAiringTvSeries() => (super.noSuchMethod(
        Invocation.method(
          #fetchAiringTvSeries,
          [],
        ),
