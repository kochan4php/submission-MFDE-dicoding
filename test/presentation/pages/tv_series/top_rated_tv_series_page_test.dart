...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      when(mockTopRatedTvSeriesNotifier.fetchTopRatedTvSeries()).thenAnswer(
        (_) async => null,
      );

      when(mockTopRatedTvSeriesNotifier.topRatedState).thenReturn(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      when(mockTopRatedTvSeriesNotifier.topRatedTvSeries).thenReturn(
        <TvSeries>[],
      );
